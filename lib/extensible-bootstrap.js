...
Ext.define('Extensible', {
    ...
    */
    Date: {
        ...
        */
       /*
        * Function diffDays() does not properly handle events that span the day when Daylight Savings
        * changes. See http://ext.ensible.com/forum/viewtopic.php?f=3&t=725&hilit=daylight for details.
        *
        * This has been fixed by Brian in Github. Remove this fix when updating the the latest version.
        */
       diffDays: function(start, end) {
